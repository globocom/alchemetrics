defmodule Alchemetrics.Annotation.Function do
  ...
  def has_metric_tag?(%Function{} = function) do
    case Module.get_attribute(function.module, @metric_tag) do
      nil -> false
      [instrument_function: true] -> true
      tag_value -> raise ArgumentError, "Invalid annotation tag @alchemetrics #{inspect tag_value}"
    end
  end
